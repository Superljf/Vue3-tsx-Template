<template>
	<a-modal v-model:visible="visible" :title="formState.guid ? '编辑部门' : '新增部门'">
		<a-form ref="formRef" name="roleForm" :model="formState" :rules="rules" :label-col="labelCol"
			...
			<a-form-item ref="parentId" label="上级部门" name="parentId">
				<a-tree-select :fieldNames="replaceFields" v-model:value="formState.parentId" style="width: 100%"
					:tree-data="treeData" allow-clear placeholder="请选择上级部门" />
			</a-form-item>
